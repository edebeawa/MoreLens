...
import edebe.more_lens.common.helper.ManaBurstHelper;
...
public class LensSprinkle extends Lens {
    ...
    public void updateBurst(IManaBurst burst, ItemStack stack) {
        ...
        if (!world.isRemote && !burst.isFake()) {
            boolean spawnBurst = ManaBurstHelper.spawnBurst(ModEntities.MANA_BURST.create(world),entity.getPosX(), entity.getPosY(), entity.getPosZ(),burst.getColor(),BURST_MANA,340,50,1F,1F,MoreLensHelper.getCompositeLens(burst.getSourceLens()),world);
            if (spawnBurst)
