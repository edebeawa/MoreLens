...
import static edebe.more_lens.common.helper.ManaItemHelper.isManaItem;
import static edebe.more_lens.common.helper.RecipeHelper.getMatchingRecipe;
...
public class LensMana extends Lens {
    ...
    private void Recipe(IManaBurst burst,ItemStack itemstack,World world,ItemEntity items) {
        ...
        IManaInfusionRecipe recipe = getMatchingRecipe(world, itemstack, state);
        if (recipe != null) {
